    ...
    <div className="rounded-2xl border border-[#F0E8D8] bg-white p-8 shadow-sm">
      ...
      {step === "input" && (
        <>
          ...
          {/* Privacy notice */}
          <div className="mb-6 rounded-xl border border-[#F5A62A] bg-[#FFF3D6] p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-[#5C4813]">⚠️ Jaga Privasi Kode Anda</p>
                <p className="mt-1 text-xs text-[#5C4813]">
                  Jangan paste kode yang mengandung <strong>password, API key, token, atau data sensitif</strong> lainnya.
                  Kami tidak menyimpan kode Anda secara permanen. Hapus informasi sensitif sebelum submit.
                </p>
              </div>
            </div>
          </div>
