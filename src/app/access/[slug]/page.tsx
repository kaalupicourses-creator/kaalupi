          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-[#F0E8D8] bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-3 text-sm">
                {[
                  { icon: "M13 10V3L4 14h7v7l9-11h-7z", label: "Level", value: course.level },
                  { icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z", label: "Durasi", value: course.duration },
                  { icon: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z", label: "Format", value: course.format, capitalize: true },
                  { icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z", label: "Modul", value: course.modules.length },
                ].map((item) => (
