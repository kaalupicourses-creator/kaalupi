...
export const courses: Course[] = [
  ...
  // Materi lagi disiapin instructor. comingSoon = tampil tapi belum bisa dibeli.
  {
    ...
    summary:
      "Kuasai jaringan Cisco dari benar-benar nol sampai konfigurasi tingkat pro. Dari OSI Layer, subnetting, switching (VLAN, STP), routing (OSPF, EIGRP), ACL, NAT, tunneling, FHRP, sampai IPv6 — semua praktik langsung di perangkat Cisco.",
    hero:
      "Skill networking yang dicari industri & wajib buat sertifikasi Cisco. Belajar step by step dari fondasi sampai bisa desain & konfigurasi jaringan enterprise beneran.",
    outcomes: [
      "Paham fondasi jaringan: OSI Layer, IPv4/IPv6 & subnetting",
      "Konfigurasi dasar perangkat Cisco (router & switch)",
      "Kuasai switching: VLAN, Trunk, STP, EtherChannel",
      "Kuasai routing: Static, EIGRP, OSPF, RIP, Redistribute",
      "Access-List, NAT, Tunneling (GRE), FHRP & IPv6 Routing",
      "Siap kerja jadi network engineer / ambil sertifikasi Cisco",
    ],
    modules: [
      "Dasar-Dasar Jaringan",
      "Konfigurasi Dasar Perangkat Cisco",
      "Switching (VLAN, Trunk, STP, EtherChannel)",
      "Routing (Static & Dynamic)",
      "Access-List (ACL)",
      "NAT & Manajemen Waktu (NTP)",
      "Tunneling (GRE)",
      "FHRP (HSRP, VRRP, GLBP)",
      "WAN Protocol (HDLC)",
      "IPv6 Routing",
