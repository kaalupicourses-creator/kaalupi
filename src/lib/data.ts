...
export const courses: Course[] = [
  // ─── CYBER SECURITY (Kamil) ───────────────────────────────────────────────
  {
    ...
    title: "Ethical Hacking & Cyber Security — Dari Nol ke Pro",
    ...
    outcomes: [
      "Ngerti cara berpikir hacker dan perbedaan ethical hacker vs cracker",
      "Setup lab Kali Linux sendiri dan kuasai tools wajib pentester",
      "Lakukan reconnaissance, scanning, dan enumeration seperti pro",
      "Pahami dan eksploitasi OWASP Top 10 secara praktis",
      "Solve lab hacking nyata di PortSwigger Web Security Academy",
      "Bisa baca dan tulis laporan pentest profesional",
      "Punya roadmap karier yang jelas: SOC, pentester, atau bug hunter",
    ],
    modules: [
      "Pengenalan & Fondasi Cyber Security",
      "Setup Lab: Kali Linux, Tools & Environment",
      "Reconnaissance & Information Gathering",
      "Vulnerability Analysis & CVE",
      "Web Security & OWASP Top 10",
      "Exploitation & Post-Exploitation",
      "Career, Bug Bounty & Roadmap",
      "BONUS — Lab Walkthrough (PortSwigger)",
    ],
    format: "blended",
    featured: true,
    is_free: false,
    ...
    is_published: true,
    perks: [
      "20+ video materi + bonus lab walkthrough PortSwigger",
