...
export const courses: Course[] = [
  ...
  // Materi lagi disiapin instructor. comingSoon = tampil tapi belum bisa dibeli.
  {
    ...
    title: "Network Engineer Pro — Dari Dasar ke Enterprise",
    ...
    regular_price: 499000,
    summary:
      "Kuasai jaringan dari nol sampai level enterprise. IP planning, subnetting, VLAN, routing, switching, sampai monitoring — semua praktik, bukan cuma teori protokol.",
    hero:
      "Skill networking tetap dicari di 2026 — cloud pun butuh orang yang paham konektivitas. Belajar dari dasar sampai bisa desain & troubleshoot jaringan beneran.",
    outcomes: [
      "Paham fondasi jaringan: IP, subnetting, dan model OSI/TCP-IP",
      "Konfigurasi VLAN, switching, dan routing",
      "Desain topologi jaringan enterprise dari nol",
      "Troubleshoot masalah konektivitas & performa",
      "Dasar network security & hardening",
      "Monitoring dan observability jaringan",
    ],
    modules: [
      "Fondasi Jaringan: IP, Subnetting & OSI",
      "Switching & VLAN",
      "Routing: Static & Dynamic",
      "Network Security & Hardening",
      "Monitoring & Observability",
      "Hands-on Lab: Desain Jaringan Enterprise",
    ],
    format: "blended",
    featured: false,
    comingSoon: true,
